...
class SystemAgent:
    """
    Agent ที่จัดการการทำงานกับระบบปฏิบัติการ
    โดยนำ Logic ทั้งหมดจาก modules/system_tools.py เดิมมาปรับโครงสร้างใหม่
    """
    def __init__(self):
    ...
    # --- เมธอดหลัก (Public Handler Method) ---
