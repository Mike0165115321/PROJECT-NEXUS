...
# This is the main entry point for the Project Nexus AI Assistant.
import uvicorn
    ...
    try:
        ...
        AGENTS = {
            ...
            "LTM": LongTermMemoryManager(
                key_manager=groq_key_manager, 
                model_name=settings.LTM_MODEL
            ),
            "FENG": FengAgent(
                key_manager=groq_key_manager,
                primary_model_name=settings.FENG_PRIMARY_MODEL,
                secondary_model_name=settings.FENG_SECONDARY_MODEL,
            ...
            "GENERAL_HANDLER": GeneralConversationAgent(
                key_manager=groq_key_manager,
                model_name=settings.FENG_PRIMARY_MODEL, # ใช้โมเดลหลักของ Feng
                rag_engine=rag_engine_instance,
                graph_manager=GRAPH_MANAGER,
                persona_prompt=FENG_PERSONA_PROMPT
            ),
            ...
            "NEWS": NewsAgent(
                ...
                news_cache_manager=news_cache_manager_instance,
                persona_prompt=FENG_PERSONA_PROMPT
            ),
